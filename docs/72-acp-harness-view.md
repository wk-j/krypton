...
- Contextual lane peek is controlled through command palette actions: `ACP: Show Lane Peek`, `ACP: Hide Lane Peek`, `ACP: Peek Next Lane`, `ACP: Peek Previous Lane`, `ACP: Activate Peeked Lane`, and `ACP: Unlock Lane Peek`.
