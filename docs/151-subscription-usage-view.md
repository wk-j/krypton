...
struct CodexScopedLimit {
    id: String,                              // metered limit_id
...
struct CodexUsage {
    primary: Option<CodexWindow>,           // default bucket; duration is authoritative
    secondary: Option<CodexWindow>,
