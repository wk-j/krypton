...
| FR-ACP-008 | The ACP Harness shall stage pasted, dropped, and global screen-captured images into the active lane composer and send them as embedded ACP image content blocks with the next prompt. | Should |
