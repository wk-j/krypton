...
| FR-ACP-012 | On macOS, `Ctrl+Shift+A` shall summon or hide a separate Live Assist native window centered in the pointer display's usable work area, above normal application windows on the active Space. | Must |
