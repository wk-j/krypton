...
| FR-ACP-012 | On macOS, `Ctrl+Shift+A` shall summon or hide a separate Live Assist native window above normal application windows on the pointer's active display and Space. | Must |
