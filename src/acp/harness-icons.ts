...
export const ACTION_HUD_SVG_DEFS = [
  ...
  '<symbol id="krypton-action-execute" viewBox="0 0 16 16"><path d="M4 5 L7 8 L4 11" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/><path d="M8.5 11 H12" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></symbol>',
