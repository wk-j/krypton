...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::daily_write_path,
            commands::daily_read_path,
            commands::xenon_push,
            ...
            commands::acp_cancel_pending_reviews,
            commands::acp_refresh_review,
            commands::list_review_bundles,
            commands::read_review_bundle,
            commands::write_review_response,
            commands::backup_review_response,
            ...
            acp::write_cline_mcp_overlay,
            acp::remove_cline_mcp_overlay,
            acp::gc_cline_mcp_overlays,
