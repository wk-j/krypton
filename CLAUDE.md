...
This project is indexed by GitNexus as **krypton** (3464 symbols, 9554 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
