...
- `DESIGN.md` — Visual identity spec (design tokens + rationale) for the Krypton Dark cyberpunk aesthetic. Load when adding UI components, modifying chrome, or verifying visual consistency
